      ...
      {!battleStarted ? (
        <div className="battle-preparation">
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              className="w-full text-black bg-white mt-1 block px-3 py-2 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              value={userName}
